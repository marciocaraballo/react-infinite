...
(function (global){
"use strict";function createInfiniteComputer(t,e){var r,n=e.count();return r=Array.isArray(t)?new ArrayInfiniteComputer(t,n):new ConstantInfiniteComputer(t,n)}function recomputeApertureStateFromOptionsAndScrollTop(t,e){var r=t.preloadBatchSize,n=t.preloadAdditionalHeight,o=t.infiniteComputer;return function(){var t=0===r?0:Math.floor(e/r),i=r*t,a=i+r,p=Math.max(0,i-n),u=Math.min(o.getTotalScrollableHeight(),a+n);return{displayIndexStart:o.getDisplayIndexStart(p),displayIndexEnd:o.getDisplayIndexEnd(u)}}()}var ConstantInfiniteComputer=require("../computers/constantInfiniteComputer.js"),ArrayInfiniteComputer=require("../computers/arrayInfiniteComputer.js"),React=global.React||require("react");module.exports={createInfiniteComputer:createInfiniteComputer,recomputeApertureStateFromOptionsAndScrollTop:recomputeApertureStateFromOptionsAndScrollTop};
